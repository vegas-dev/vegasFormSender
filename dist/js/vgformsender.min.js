...
(function(a){a.fn.vegasFormSender=function(b){function c(b){let c={empty:[],email:[],password:[],checkbox:[],select:[],radio:[]};if(b.each(function(){let b=a(this);if(""===b.val())c.empty.push(b);else if("checkbox"===b.attr("type")&&!b.is(":checked"))c.checkbox.push(b);else if("radio"===b.attr("type"))c.radio.push(b);else if("SELECT"===b[0].tagName){let d=a(this).attr("multiple");if("undefined"!=typeof d&&!1!==d)b.find("option:selected").length||c.select.push(b);else{let a=b.find("option:selected").attr("value");a||c.select.push(b)}}else{let a=b.data("validate");"email"!==a&&"email"!==b.attr("type")||d(b.val())||c.email.push(b),"password"===a&&c.password.push(b)}}),1<c.password.length){let a=[];for(let b,d=1;d<=c.password.length;d++)b=c.password[d-1],a.push(b.val());a=a.filter(function(a,b,c){return c.indexOf(a)===b}),1===a.length&&(c.password=[])}if(c.radio.length){let b=[],d=[];a.each(c.radio,function(){b.push(a(this).attr("name"))}),b=b.filter(function(a,b,c){return c.indexOf(a)===b}),a.each(b,function(b,e){d.push({name:e,self:[]}),a.each(c.radio,function(){let c=a(this).attr("name");d[b].name===c&&d[b].self.push(a(this))})}),a.each(d,function(b){let c=0;a.each(d[b].self,function(){let b=a(this);b.is(":checked")||c++}),d[b].self.length!==c&&(d[b].self=[])}),c.radio=[],a.each(d,function(b){a.each(d[b].self,function(){c.radio.push(a(this))})})}return c}function d(a){return /[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/.test((a+"").toLowerCase())}return b=a.extend({error:function(){},success:function(){},beforeSend:function(){},validate:function(){}},arguments[0]||{}),this.each(function(){let d=a(this),e={action:b.action||d.attr("action")||location.href,method:b.method||d.attr("method")||"get",fields:!!b.fields&&b.fields,jsonParse:b.jsonParse||d.data("json-parse")||!1,lang:b.lang||d.data("lang")||"ru",redirectSuccess:b.redirectSuccess||d.data("redirect-success")||!1,redirectError:b.redirectError||d.data("redirect-error")||!1};e.fields&&"function"==typeof e.fields&&(e.fields=b.fields());let f={lang:e.lang};d.addClass("vg-form-sender");let g=d.find("input, select, textarea");g.each(function(){a(this).parent("div").addClass("vg-form-sender__selector")}),d.on("submit",function(){let g=new FormData(this),h=a(this).find("[data-validate]"),i=a(this).find("[type=email]"),j={},k=!0;if(i.length&&(j=c(i),j.email.length&&(k=!1)),h.length&&(j=c(h),(j.empty.length||j.email.length||j.password.length||j.checkbox.length||j.radio.length||j.select.length)&&(k=!1)),!k)b.validate.call(this,d,f,j);else{if(e.fields)for(let a in e.fields)if("object"==typeof e.fields[a])for(let b in e.fields[a]){let c=Object.keys(e.fields[a][b]).map(function(c){return e.fields[a][b][c]});g.append(a,c)}else g.append(a,e.fields[a]);a.ajax({url:e.action,method:e.method,data:g,cache:!1,contentType:!1,processData:!1,beforeSend:function(){b.beforeSend.call(this,d,f),d.trigger("before-send")},success:function(a){let c;d.trigger("submit-success"),c=e.jsonParse?JSON.parse(a):a,e.redirectSuccess?window.location.href=e.redirectSuccess:b.success.call(this,c,d,f)},error:function(a){let c,g=JSON.parse(a.responseText);d.trigger("submit-error"),c=g.errors?g.errors[Object.keys(g.errors)[0]][0]:g.message||g.msg,e.redirectError?window.location.href=e.redirectError:b.error.call(this,c,d,f)}})}return!1})})}})(jQuery);
window.LangFormSender={ru:{alert:{success_title:"\u0423\u0441\u043F\u0435\u0448\u043D\u043E!",success_msg:"\u0412\u0430\u0448\u0435 \u043F\u0438\u0441\u044C\u043C\u043E \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E!",error_title:"\u041E\u0448\u0438\u0431\u043A\u0430!",text_send:"\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u044F\u0435\u043C...",btn_text:"\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C"},validate:{empty:"\u042D\u0442\u043E \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E\u0435 \u043F\u043E\u043B\u0435",email:"\u0412\u044B \u0432\u0432\u0435\u043B\u0438 \u043D\u0435 \u0432\u0435\u0440\u043D\u044B\u0439 email \u0430\u0434\u0440\u0435\u0441",password:"\u0412\u0435\u0434\u0435\u043D\u043D\u044B\u0435 \u043F\u0430\u0440\u043E\u043B\u0438 \u043D\u0435 \u0441\u043E\u0432\u043F\u0430\u0434\u0430\u044E\u0442",checkbox:"\u0427\u0442\u043E\u0431\u044B \u043F\u0440\u043E\u0434\u043B\u043E\u043B\u0436\u0438\u0442\u044C, \u0443\u0441\u0442\u0430\u043D\u043E\u0432\u0438\u0442\u0435 \u044D\u0442\u043E\u0442 \u0444\u043B\u0430\u0436\u043E\u043A",radio:"\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u043E\u0434\u0438\u043D \u0438\u0437 \u0432\u0430\u0440\u0438\u0430\u043D\u0442\u043E\u0432",select:"\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0432\u0430\u0440\u0438\u0430\u043D\u0442 \u0438\u0437 \u0441\u043F\u0438\u0441\u043A\u0430"}},en:{alert:{success_title:"Success!",success_msg:"Your email has been successfully sent!",error_title:"Error!",text_send:"We send...",btn_text:"Send message"},validate:{empty:"This is a required field",email:"You entered an invalid email address",password:"The passwords entered do not match",checkbox:"Check this box to continue",radio:"Choose one of the options",select:"Choose an option from the list"}}};
