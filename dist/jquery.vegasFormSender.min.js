 ...
 * }
 */
!function(e){e.fn.vegasFormSender=function(r){var t=this,o=(r=e.extend({error:function(){},success:function(){}},arguments[0]||{})).action||t.attr("action")||location.href,n=r.method||t.attr("method")||"get",s=!!r.fields&&r.fields,a=r.redirectSuccess||t.data("redirect-success")||!1,c=r.redirectError||t.data("redirect-error")||!1;return s&&"function"==typeof s&&(s=r.fields()),t.on("submit",function(){var t=new FormData(this);if(s)for(var i in s)t.append(i,s[i]);return e.ajax({url:o,method:n,data:t,cache:!1,contentType:!1,processData:!1,success:function(t){var o=e.parseJSON(t);a&&(window.location.href=a),r.success.call(this,o)},error:function(e,t){0===e.status?msg="Not connect.\n Verify Network.":404==e.status?msg="Requested page not found. [404]":500==e.status?msg="Internal Server Error [500].":msg="parsererror"===t?"Requested JSON parse failed.":"timeout"===t?"Time out error.":"abort"===t?"Ajax request aborted.":"Uncaught Error.\n"+e.responseText,c&&(window.location.href=c),r.error.call(this,"")}}),!1}),this}}(jQuery);